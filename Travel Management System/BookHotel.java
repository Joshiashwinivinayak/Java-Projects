...
public class BookHotel extends JFrame implements ActionListener {
    ...
    JButton b1, b2, b3;
    BookHotel(String username, String dname){
        ...
        l21 = new JLabel();
        l21.setBounds(250, 30, 170, 30);
        add(l21);
        
        JLabel l15 = new JLabel("destination: ");
        l15.setBounds(20, 70, 100, 30);
        add(l15);
        ...
        try{
            ...
            while(ss.next()){
                l26.setText(ss.getString("dname"));
            }
