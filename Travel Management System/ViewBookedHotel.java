...
public class ViewBookedHotel extends JFrame {
	...
	public ViewBookedHotel(String username)  {
		...
		lblName.setBounds(95, 0, 350, 53);
		contentPane.add(lblName);
                
                JLabel lb3 = new JLabel("Username :");
		lb3.setBounds(35, 40, 200, 14);
		contentPane.add(lb3);
                
                JLabel l1 = new JLabel();
		l1.setBounds(271, 40, 200, 14);
		contentPane.add(l1);
                
                JLabel l26 = new JLabel("Destination :");
		l26.setBounds(35, 75, 200, 14);
		contentPane.add(l26);
                
                JLabel l11 = new JLabel();
		l11.setBounds(271, 75, 200, 14);
		
                contentPane.add(l11);
                JLabel lblId = new JLabel("Name :");
		lblId.setBounds(35, 115, 200, 14);
		contentPane.add(lblId);
                
                JLabel l2 = new JLabel();
		l2.setBounds(271, 115, 200, 14);
		contentPane.add(l2);
                
                JLabel lb2 = new JLabel("Number of Persons :");
		lb2.setBounds(35, 155, 200, 14);
		contentPane.add(lb2);
                
                JLabel l3 = new JLabel();
		l3.setBounds(271, 155, 200, 14);
		contentPane.add(l3);
		
		JLabel lblName_1 = new JLabel("Number of Days :");
		lblName_1.setBounds(35, 195, 200, 14);
		contentPane.add(lblName_1);
		
		JLabel l4 = new JLabel();
		l4.setBounds(271, 195, 200, 14);
		contentPane.add(l4);

                
		JLabel lblGender = new JLabel("AC / Non-AC :");
		lblGender.setBounds(35, 235, 200, 14);
		contentPane.add(lblGender);
                
                JLabel l5 = new JLabel();
		l5.setBounds(271, 235, 200, 14);
		contentPane.add(l5);
                
		JLabel lblCountry = new JLabel("Food Included (Yes/No) :");
		lblCountry.setBounds(35, 275, 200, 14);
		contentPane.add(lblCountry);
                
                JLabel l6 = new JLabel();
		l6.setBounds(271, 275, 200, 14);
		contentPane.add(l6);
		
		JLabel lblReserveRoomNumber = new JLabel("ID :");
		lblReserveRoomNumber.setBounds(35, 315, 200, 14);
		contentPane.add(lblReserveRoomNumber);
                
                JLabel l7 = new JLabel();
		l7.setBounds(271, 315, 200, 14);
		contentPane.add(l7);
           	
		JLabel lblCheckInStatus = new JLabel("Number :");
		lblCheckInStatus.setBounds(35, 355, 200, 14);
		contentPane.add(lblCheckInStatus);
                
                JLabel l8 = new JLabel();
		l8.setBounds(271, 355, 200, 14);
		contentPane.add(l8);

		
		JLabel lblDeposite = new JLabel("Phone :");
		lblDeposite.setBounds(35, 395, 200, 14);
		contentPane.add(lblDeposite);
		
		JLabel l9 = new JLabel();
		l9.setBounds(271, 395, 200, 14);
		contentPane.add(l9);
                
                JLabel la2 = new JLabel("Cost :");
		la2.setBounds(35, 435, 200, 14);
		contentPane.add(la2);
		
		JLabel l10 = new JLabel();
		l10.setBounds(271, 435, 200, 14);
		contentPane.add(l10);
                ...
                try{
                    ...
                    ResultSet ss = c.s.executeQuery("select * from selectdestination where username = '"+username+"'");
                    while(ss.next()){
                    l11.setText(ss.getString("dname"));
                    }
